...
try:
  ...
  #stuff = api.user_timeline(screen_name = "elonmusk", count = 200, include_rts = False , tweet_mode = 'extended', exclude_replies=True)
  #print( "\nПоследние {0} твитов пользователя {1}\n".format(sys.argv[2], stuff[0].user.name))
